...
parser.add_argument('--test_data_path', default='../../../D2_data/audio_data_OTR', type=str, action='append', nargs='*')
...
parser.add_argument('--test_meta_data_path', default='../../../D2_data/meta2', type=str, action='append', nargs='*')
